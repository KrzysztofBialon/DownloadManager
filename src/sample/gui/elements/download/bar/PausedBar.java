...
public class PausedBar
{
    private HBox wrapper;
    private Label downloadStatus = new Label("paused");//TODO add status listener
    ...
    public PausedBar(FileDetailsClass detailsClass) {
        ...
        //TODO move to action
        this.progressBar.progressProperty().setValue();
